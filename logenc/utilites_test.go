...
func TestEncodeLine(t *testing.T) {
	...
	tests := []struct {
		...
		// TODO: Add test cases.
		{
			name: "TestEncodeLine",
			args: args{line: line},
			want: "",
		},
	}
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
